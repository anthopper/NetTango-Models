...
403
listen
 let volume round ((vibration-amplitude / 50) * 127) + 30\n  \n let index position vibration-frequency [ 1.5 1.75 2 2.25 2.5 2.75 3 3.25 3.5 3.75 4 ]\n let pitch item index [48 51 53 55 57 59 60 62 63 64 65]\n\n sound:play-note \"Bright Acoustic Piano\" pitch volume 10
NIL
1
T
OBSERVER
